...
const MessageItem = memo(function MessageItem({
  ...
  const messageError =
    isAssistant && message.info.role === "assistant" ? message.info.error : null;
  const errorDescription = messageError ? describeMessageError(messageError) : null;
...
function describeMessageError(
  ...
  switch (error.name) {
    case "APIError": {
      ...
      return {
        title: status ? `Provider API error (HTTP ${status})` : "Provider API error",
