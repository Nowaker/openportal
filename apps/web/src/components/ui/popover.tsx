...
const PopoverContent = ({
  ...
  return (
    <PopoverPrimitive
      ...
      offset={offset}
      className={cx(
        "group/popover min-w-(--trigger-width) max-w-xs origin-(--trigger-anchor-point) rounded-(--popover-radius) border border-fg/10 bg-overlay text-sm text-overlay-fg shadow-xs outline-hidden transition-transform [--gutter:--spacing(6)] [--popover-radius:var(--radius-xl)] dark:backdrop-saturate-200 **:[[role=dialog]]:[--gutter:--spacing(6)]",
